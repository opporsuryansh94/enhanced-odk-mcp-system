...
from src.models.submission import db, Submission
...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'data-collection-secret-key-change-in-production')
...
# Register blueprints
app.register_blueprint(submissions_bp, url_prefix='/v1')
...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'service': 'Data Collection & Synchronization MCP',
        'version': '1.0.0'
    }), 200
